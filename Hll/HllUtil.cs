// <copyright file="HllUtil.cs" company="Microsoft">
...
namespace DataSketches.Hll
{
    ...
    {
        /// <summary>
        /// Inverse powers of 2 lookup table for HIP estimator
        /// </summary>
        internal static readonly double[] InversePowersOf2 = new double[256]
        {
            1, 0.5, 0.25, 0.125,
